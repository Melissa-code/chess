class View {
  ...
  afficherPieces() {
    for (let i = 0; i < this.echiquier.listePieces.length; i++) {
      ...
      this.ctx.font = this.tailleCarreau * 0.7 + "px Raleway";
      ...
      if (piece.isMoved) {
        ...
        // Redessine la case
        this.ctx.fillStyle =
          (piece.oldPosition.j + piece.oldPosition.i) % 2 === 0
            ? "#778da9"
            : "#293241";
        this.ctx.fillRect(
          piece.oldPosition.j * this.tailleCarreau,
  ...
  createChessImage(player, imgSrc) {
    ...
    container.style.backgroundColor =
      this.echiquier.tourDuJoueur === "white" ? "#415a77" : "#778da9";
  ...
  displayTurnOfPlayer() {
    ...
    const imgSrc =
      this.echiquier.tourDuJoueur === "white"
        ? "images/chess_white1.svg"
        : "images/chess1.svg";
